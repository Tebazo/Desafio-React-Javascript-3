...
function App() {
  ...
  const barValidade = () =>{
    let bar = 0;
    let barLength = 100/(Object.values(data).length);
  ...
  return (
    ...
    <div className='App'>
      <h3>desafio 3 - React/Javascript</h3>
      <h1>progresso do formulário</h1>

      <main>
        <div className="bar-container">
          <div className="bar" style={{width : `${barValidade()}%`}}>
          </div>
        </div>
        ...
        <button onClick={resetAll}  disabled = {barValidade() !== 100}>Enviar Formulário</button>
      </main>
    </div>
  );
}
